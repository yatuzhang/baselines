...
class DataDistribution:
  ...
  def update_data(self, data):
    ...
    self.v_envs = np.array(data['v_envs'])
    assert len(self.obs) == len(self.v_envs), ('length mismatch')
  ...
  def sample(self, numSamples):
    ...
    return self.obs[start:end], self.pi[start:end], self.v_envs[start:end], self.epochs_completed
